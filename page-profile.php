                    ...
                    echo "
                        <div class=\"info-container\">
                            <table>
                                <tr>
                                    <th>Name:</th>
                                    <td><input type=\"text\" readonly  class=\"name-txt\" value=\"$name\"></td>
                                </tr>
                                <tr>
                                    <th>Email:</th>
                                    <td><input type=\"text\" readonly class=\"name-txt\" value=\"$email\"></td>
                                </tr>
                                <tr>
                                    <th>password:</th>
                                    <td><input type=\"password\" readonly class=\"name-txt\" value=\"$password\"></td>
                                </tr>
                            </table>
                            <a href=\"./page-profileEdit.php\" class=\"edit-btn\"><div>Edit</div></a>
                            <a href=\"./Function/delete-profile.php\" class=\"del-btn\"><div>Delete Account</div></a>
                        </div>
                    "
                ?>
